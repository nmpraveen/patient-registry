...
3. Complete Firebase setup for MEDTRACK.
...
4. Decide Android create-case and lock-flow scope.
...
5. Keep the temporary elevated mobile worklist behavior explicit.
...
7. Record field readiness without PHI.
