...
- Stages 4 and 5 must integrate from their actual predecessor squash commits and retain separate PR/review gates. [Stage 3 contract](docs/issue-113-stage-3.md).
