...
val securityDependencyOverrides = mapOf(
    ...
    "io.netty:netty-buffer" to "4.1.137.Final",
    ...
    "io.netty:netty-codec-socks" to "4.1.137.Final",
    ...
    "io.netty:netty-resolver" to "4.1.137.Final",
    "io.netty:netty-transport" to "4.1.137.Final",
    "io.netty:netty-transport-native-unix-common" to "4.1.137.Final",
)
