...
def _serialize_category(category):
    return {
        ...
        "starter_task_templates": category.starter_task_templates,
...
def _serialize_patient(patient_like, *, merged_into_uhid=None, is_temporary_id=None):
    ...
    return {
        ...
        "blood_group": getattr(patient_like, "blood_group", ""),
    ...
    with transaction.atomic():
        for category_name, category_data in category_payload_by_name.items():
            ...
            category = DepartmentConfig(
                ...
                starter_task_templates=category_data.get("starter_task_templates") or [],
...
def _import_payload(payload, categories_by_name, users_by_username):
    ...
    for case_data in payload.get("cases", []):
        ...
        case = Case(
            ...
            blood_group=case_data.get("blood_group", ""),
            ...
            ftnd=_optional_int(case_data.get("ftnd"), default=0),
            lscs=_optional_int(case_data.get("lscs"), default=0),
            metadata=metadata,
